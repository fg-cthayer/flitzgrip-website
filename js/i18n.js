const TRANSLATIONS = {
  en: {
    ...
    'about-p1':         "We're a climbing family based in Berlin. After the initial honeymoon phase with the sport, our hands started taking real damage. We tried plenty of good products out there, but we were looking for a very specific feel. We wanted something solid, completely waterless, and stripped down to the essentials. So we made our own.",
    'about-p2':         'What started in our kitchen was just meant for our own gym bags. But after sharing it with friends and family and seeing their reaction, we realized other people were looking for that exact same feel.',
    'about-p3':         'FlitzGrip is our take on skin repair. Seven organic ingredients, poured by hand into a solid 18g bar. No water, no extra noise, just a simple, considered tool that replaces natural oils and promotes recovery. Made with care in Berlin.',
  ...
  de: {
    ...
    'about-p1':         'Wir sind eine Kletterfamilie aus Berlin. Nach der anfänglichen Begeisterungsphase für den Sport begannen unsere Hände, echten Schaden zu nehmen. Wir haben viele gute Produkte ausprobiert, aber wir suchten nach einem ganz bestimmten Gefühl. Wir wollten etwas Festes, völlig wasserfrei und auf das Wesentliche reduziert. Also haben wir unser eigenes hergestellt.',
    'about-p2':         'Was in unserer Küche begann, war zunächst nur für unsere eigenen Gym-Bags gedacht. Aber nachdem wir es mit Freunden und Familie geteilt und ihre Reaktion gesehen hatten, merkten wir, dass andere Menschen nach genau demselben Gefühl suchten.',
    'about-p3':         'FlitzGrip ist unsere Version von Hautpflege. Sieben Bio-Inhaltsstoffe, von Hand in einen festen 18g-Riegel gegossen. Kein Wasser, kein unnötiges Beiwerk – einfach ein durchdachtes Werkzeug, das natürliche Öle ersetzt und die Regeneration fördert. Mit Sorgfalt in Berlin hergestellt.',
