const TRANSLATIONS = {
  en: {
    ...
    'solution-p':       'FlitzGrip replaces what your skin loses. Seven organic ingredients. No fillers, no fragrance, no shortcuts. Apply after training. Wake up ready.',
    ...
    'ing-h2':           'Seven ingredients.<br>Zero fillers.',
    ...
    'ing-05-p':         'Antimicrobial and intensely moisturising. Protects open fissures from infection while they heal.',
    'ing-06-p':         'Powerful antioxidant that fights free radicals. Reduces scarring and keeps skin supple long-term.',
    'ing-07-p':         'Anti-inflammatory extract used for centuries on wounds and sore skin. Calms redness and irritation.',
  ...
  de: {
    ...
    'solution-p':       'FlitzGrip gibt der Haut zurück, was sie verliert. Sieben Bio-Inhaltsstoffe. Keine Füllstoffe, kein Duft, keine Abkürzungen. Nach dem Training auftragen. Erholt aufwachen.',
    ...
    'ing-h2':           'Sieben Inhaltsstoffe.<br>Null Füllstoffe.',
    ...
    'ing-05-p':         'Antimikrobiell und intensiv feuchtigkeitsspendend. Schützt offene Risse vor Infektionen während der Heilung.',
    'ing-06-p':         'Starkes Antioxidans gegen freie Radikale. Reduziert Narbenbildung und hält die Haut langfristig geschmeidig.',
    'ing-07-p':         'Entzündungshemmendes Extrakt aus der Volksmedizin. Beruhigt Rötungen und Reizungen an gerissener Haut.',
