const TRANSLATIONS = {
  en: {
    ...
    'product-hook':     'FlitzGrip Skin Repair Bar is a solid balm built to recover raw, chalk-stripped hands after your session. Shipped in a plant-based, 3D-printed container that clips straight to your chalk bag, it is designed to replenish the natural oils lost during climbing.',
    'formula-1-name':   'Jojoba Oil',
    'formula-1-role':   'Lipid replacement',
    'formula-2-name':   'St. John\'s Wort',
    'formula-2-role':   'Active recovery',
    'formula-3-name':   'Vitamin E',
    'formula-3-role':   'Structural protection',
    'attr-organic':     '100% Organic',
    'attr-waterfree':   'Water-Free',
    'attr-cruelty':     'Cruelty-Free',
    'attr-eco':         'Biodegradable Pack',
    'attr-made':        'Made in Berlin',
  ...
  de: {
    ...
    'product-name':     'FlitzGrip<sup class="tm">™</sup>',
    'product-hook':     'Der FlitzGrip Skin Repair Bar ist ein fester Balsam, entwickelt um rohe, chalk-gestresste Hände nach der Session zu regenerieren. Im pflanzenbasierten, 3D-gedruckten Behälter geliefert, der sich direkt an die Chalkbag clippt – konzipiert, um die beim Klettern verlorenen natürlichen Öle zu ersetzen.',
    'formula-1-name':   'Jojobaöl',
    'formula-1-role':   'Lipidersatz',
    'formula-2-name':   'Johanniskraut',
    'formula-2-role':   'Aktive Regeneration',
    'formula-3-name':   'Vitamin E',
    'formula-3-role':   'Strukturschutz',
    'attr-organic':     '100% Bio',
    'attr-waterfree':   'Wasserfrei',
    'attr-cruelty':     'Cruelty-Free',
    'attr-eco':         'Biologisch abbaubar',
    'attr-made':        'Made in Berlin',
